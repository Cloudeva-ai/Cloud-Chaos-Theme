...
def screen_register():
    ...
    if laptop_video_mp4.exists():
        ...
        laptop_video_html = f"""
        <video src="{laptop_src}" autoplay loop muted playsinline webkit-playsinline preload="none"
               poster=""
    ...
    if watch_video.exists():
        ...
        watch_video_html = f"""
        <video src="{watch_src}" autoplay loop muted playsinline webkit-playsinline preload="none"
               poster=""
               onloadedmetadata="this.play().catch(() => {{}})"
               oncanplay="this.play().catch(() => {{}})"
               style="width:100%;height:140px;object-fit:cover;display:block;background:#fff">
